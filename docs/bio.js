...
function initApp() {
  ...
  if (window.i18n) {
    if (window.i18n?.translations?.models) {
...
function tryLoadModelsDirectly(forceReload = false, paper) {
  if (window.i18n) {
    if (window.i18n.translations && window.i18n.translations.models) {
      console.log(
        "[bio.js] Models found directly in i18n:",
        window.i18n.translations.models,
      );
      return processModels(window.i18n.translations.models, paper);
    } else {
      console.log(
        "[bio.js] i18n.translations.models not available:",
      ...
      if (forceReload && typeof window.i18n.loadTranslations === "function") {
        ...
        window.i18n
          ...
          .then(() => {
            if (window.i18n.translations && window.i18n.translations.models) {
              console.log(
                "[bio.js] Models loaded after forced reload:",
                window.i18n.translations.models,
              );
